...
namespace WpfAsservissementDisplayNew
{
    /// <summary>
    ...
    public partial class AsservissementRobot4RouesHoloDisplayControl : UserControl
    {
        ...
        public void UpdatePolarConsigneValues(double consigneX, double consigneY, double consigneTheta)
        {
            consigneXList.Enqueue(consigneX);
            consigneYList.Enqueue(consigneY);
            consigneThetaList.Enqueue(consigneTheta);
        }
        public void UpdateIndependantConsigneValues(double consigneM1, double consigneM2, double consigneM3, double consigneM4)
        {
        ...
        public void UpdatePolarCommandValues(double commandX, double commandY, double commandTheta)
        {
        ...
        public void UpdatePolarOdometry(double valueX, double valueY, double valueTheta)
        {
            measuredXList.Enqueue(valueX);
            measuredYList.Enqueue(valueY);
            measuredThetaList.Enqueue(valueTheta);
        }
        public void UpdateIndependantOdometry(double valueM1, double valueM2, double valueM3, double valueM4)
        {
        ...
        public void UpdatePolarErrorValues(double errorX, double errorY, double errorTheta)
        {
            errorXList.Enqueue(errorX);
            errorYList.Enqueue(errorY);
            errorThetaList.Enqueue(errorTheta);
        }
        public void UpdateIndependantErrorValues(double errorM1, double errorM2, double errorM3, double errorM4)
        {
        ...
        public void UpdatePolarCorrectionValues(double corrPX, double corrPY, double corrPTheta,
        ...
        public void UpdateIndependantCorrectionValues(double corrPM1, double corrPM2, double corrPM3, double corrPM4,
        ...
        public void UpdatePolarCorrectionGains(double KpX, double KpY, double KpTheta,
        ...
        public void UpdateIndependantCorrectionGains(double KpM1, double KpM2, double KpM3, double KpM4,
        ...
        public void UpdatePolarCorrectionLimits(double corrLimitPX, double corrLimitPY, double corrLimitPTheta,
        ...
        public void UpdateIndependantCorrectionLimits(double corrLimitPM1, double corrLimitPM2, double corrLimitPM3, double corrLimitPM4,
